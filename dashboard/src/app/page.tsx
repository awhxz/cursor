...
const emptyPayload: DashboardPayload = { rows: [], columns: [], fetchedAt: "", source: "public-csv" };
...
export default function DashboardPage() {
  ...
  useEffect(() => { loadData(); const id = setInterval(loadData, 5 * 60 * 1000); return () => clearInterval(id); }, []);
  ...
  return <main className="shell">
    <section className="hero">
      <div><p className="eyebrow">Google Sheets → веб-дашборд</p><h1>Дашборд руководителя</h1><p className="muted">Актуальная сводка по задачам без ручной выгрузки Excel.</p></div>
